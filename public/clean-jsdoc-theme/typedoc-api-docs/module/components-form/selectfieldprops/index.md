...
kind: interface
longname: module:components/Form.SelectFieldProps
description: Select field props
---

# SelectFieldProps

<Signature
  code="interface SelectFieldProps extends module:components/Form.FormFieldProps {
	children?: unknown;
	className?: string;
...
<SourceLink href="/source/docs-site/typedoc-src/components/form-ts/#L432" label="Form.ts:432" />
...
<MemberHeading id="emptylabel" depth="3" name="emptyLabel" sig="emptyLabel: string" />

<MemberMeta sourceHref="/source/docs-site/typedoc-src/components/form-ts/#L438" sourceLabel="Form.ts:438" />
...
<MemberHeading id="multiple" depth="3" name="multiple" sig="multiple: boolean" />

<MemberMeta sourceHref="/source/docs-site/typedoc-src/components/form-ts/#L436" sourceLabel="Form.ts:436" />
...
<MemberHeading id="options" depth="3" name="options" sig="options: SelectOption[]" />

<MemberMeta sourceHref="/source/docs-site/typedoc-src/components/form-ts/#L434" sourceLabel="Form.ts:434" />
