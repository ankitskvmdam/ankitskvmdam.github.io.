...
title: TextField
kind: class
longname: module:components/Form.TextField
description: Text input field component
---

# TextField

<SourceLink href="/source/docs-site/typedoc-src/components/form-ts/#L387" label="Form.ts:387" />
...
<MemberHeading id="constructor" depth="3" name="constructor" sig="new TextField(props: TextFieldProps): TextField" />

**Parameters**

- `props` ([TextFieldProps](/module/components-form/textfieldprops)) — Initial component props
...
<MemberHeading id="props" depth="3" name="_props" sig="_props: TextFieldProps" />
...
<MemberHeading id="checkrule" depth="3" name="checkRule" sig="checkRule(rule: ValidationRule, value: string): boolean" />
...
<MemberHeading id="formatvalue" depth="3" name="formatValue" sig="formatValue(value: string): string" />
...
<MemberHeading id="getdefaultvalue" depth="3" name="getDefaultValue" sig="getDefaultValue(): string" />

<MemberMeta badges="protected" sourceHref="/source/docs-site/typedoc-src/components/form-ts/#L392" sourceLabel="Form.ts:392" />
...
<MemberHeading id="getvalue" depth="3" name="getValue" sig="getValue(): string" />
...
<MemberHeading id="isempty" depth="3" name="isEmpty" sig="isEmpty(value: string): boolean" />
...
<MemberHeading id="parsevalue" depth="3" name="parseValue" sig="parseValue(rawValue: unknown): string" />

<MemberMeta badges="protected" sourceHref="/source/docs-site/typedoc-src/components/form-ts/#L388" sourceLabel="Form.ts:388" />
...
<MemberMeta sourceHref="/source/docs-site/typedoc-src/components/form-ts/#L396" sourceLabel="Form.ts:396" />
...
<MemberHeading id="setvalue" depth="3" name="setValue" sig="setValue(value: string, options: { validate?: boolean }): void" />
