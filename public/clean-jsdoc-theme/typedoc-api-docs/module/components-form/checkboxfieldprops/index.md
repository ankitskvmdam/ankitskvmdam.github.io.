---
title: CheckboxFieldProps
kind: interface
longname: module:components/Form.CheckboxFieldProps
description: Checkbox field props
---

# CheckboxFieldProps

<Signature
  code="interface CheckboxFieldProps extends module:components/Form.FormFieldProps {
...
<SourceLink href="/source/docs-site/typedoc-src/components/form-ts/#L505" label="Form.ts:505" />
...
<MemberHeading id="checkboxlabel" depth="3" name="checkboxLabel" sig="checkboxLabel: string" />

<MemberMeta sourceHref="/source/docs-site/typedoc-src/components/form-ts/#L507" sourceLabel="Form.ts:507" />
