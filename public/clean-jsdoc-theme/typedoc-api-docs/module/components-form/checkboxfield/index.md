...
title: CheckboxField
kind: class
longname: module:components/Form.CheckboxField
description: Checkbox field component
---

# CheckboxField

<SourceLink href="/source/docs-site/typedoc-src/components/form-ts/#L515" label="Form.ts:515" />
...
<MemberHeading id="constructor" depth="3" name="constructor" sig="new CheckboxField(props: CheckboxFieldProps): CheckboxField" />

**Parameters**

- `props` ([CheckboxFieldProps](/module/components-form/checkboxfieldprops)) — Initial component props
...
<MemberHeading id="props" depth="3" name="_props" sig="_props: CheckboxFieldProps" />
...
<MemberHeading id="checkrule" depth="3" name="checkRule" sig="checkRule(rule: ValidationRule, value: boolean): boolean" />
...
<MemberHeading id="formatvalue" depth="3" name="formatValue" sig="formatValue(value: boolean): string" />
...
<MemberHeading id="getdefaultvalue" depth="3" name="getDefaultValue" sig="getDefaultValue(): boolean" />

<MemberMeta badges="protected" sourceHref="/source/docs-site/typedoc-src/components/form-ts/#L520" sourceLabel="Form.ts:520" />
...
<MemberHeading id="getvalue" depth="3" name="getValue" sig="getValue(): boolean" />
...
<MemberHeading id="isempty" depth="3" name="isEmpty" sig="isEmpty(value: boolean): boolean" />

<MemberMeta badges="protected" sourceHref="/source/docs-site/typedoc-src/components/form-ts/#L524" sourceLabel="Form.ts:524" />

_Overrides&#x20;_[`isEmpty`](/module/components-form/formfield#isempty)
...
<MemberHeading id="parsevalue" depth="3" name="parseValue" sig="parseValue(rawValue: unknown): boolean" />

<MemberMeta badges="protected" sourceHref="/source/docs-site/typedoc-src/components/form-ts/#L516" sourceLabel="Form.ts:516" />
...
<MemberMeta sourceHref="/source/docs-site/typedoc-src/components/form-ts/#L529" sourceLabel="Form.ts:529" />
...
<MemberHeading id="setvalue" depth="3" name="setValue" sig="setValue(value: boolean, options: { validate?: boolean }): void" />
