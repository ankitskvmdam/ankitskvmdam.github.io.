 ...
 * Original file: /npm/@mediapipe/tasks-vision@0.10.22-rc.20250304/vision_bundle.mjs
 *
...
var K = z("jas", void 0, !0),
  ...
  Z = z(void 0, "8utk");
const Q = W ? K : "Ea",
  tt = { Ea: { value: 0, configurable: !0, writable: !0, enumerable: !1 } },
...
var Ae = class extends Ee {
  ...
  set(t, e) {
    return (
      ...
      null == (t = this.S(t, !0, !1))
        ...
        : null == e
          ? (super.delete(t), this)
          : super.set(t, this.X(e, !0, !0, this.I, !1, this.M))
    );
  }
  Ja(t) {
  ...
  get(t) {
    ...
    if (void 0 !== e) {
      var n = this.I;
      return n
        ? ((n = this.X(e, !1, !0, n, this.pa, this.M)) !== e && super.set(t, n),
          n)
        : e;
    }
  }
      ...
      return 2 & r
        ...
        : ((e &&= 0 === r || (!!(32 & r) && !(64 & r || !(16 & r)))),
          e
            ...
            : Pe(t, Be, 4 & r ? ot : n, !0, !0));
    }
    return (
      t.W === ut
        ? (t = 2 & (r = 0 | (n = t.u)[Q]) ? t : new t.constructor(Ge(n, r, !0)))
        : t instanceof Ae &&
          !(2 & t.M) &&
...
function bn(t, e, n) {
  {
    ...
    if ((pt(a), null == n)) We(o, a, e);
      ...
      for (
        i || (t = 0),
          s ||
            ((n = ct(n)), (r = 0), (t = gn((t = pn(t, a)), a, !0)), (s = !1)),
          t |= 21,
          i = 0;
        i < n.length;
        i++
      ...
      (t !== r &&
        (s && ((n = ct(n)), (t = gn((t = pn(t, a)), a, !0))), rt(n, t)),
        We(o, a, e, n));
    }
  }
}
...
function Ln(t) {
  if ("string" == typeof t) return { buffer: P(t), O: !1 };
  ...
  if (t.constructor === N) return { buffer: D(t) || new Uint8Array(0), O: !0 };
...
function Hn(t) {
  ...
  if (((t = t.h), s)) {
    var c,
      h = t;
    ((c = i) || (c = i = new TextDecoder("utf-8", { fatal: !0 })),
      (o = a + o),
  ...
  (((i = {}).Ma = r),
    (i.T = (function (t) {
      switch (typeof t) {
        ...
        case "number":
          return t > 0 ? void 0 : 0 === t ? (Fe ||= [0, void 0]) : [-t, void 0];
        case "string":
          return [0, t];
        case "object":
          return t;
...
var ni = Wr(
  ...
  _i = Ar(function (t, e, n, r, i, s) {
    return (
      2 === t.h && (sn(e, 0 | e[Q], s, n), Xn(t, (e = an(e, r, n)), i), !0)
    );
  }, Qr),
  vi = Wr(
    function (t, e, n) {
...
ji[458105876] = [0, yo, Yr, [!0, oi, [0, mi, -1, pi]]];
...
function zo(t, e) {
  ...
  ("string" == typeof e
    ? (He(n, 2, de(e)), He(n, 1))
    : e instanceof Uint8Array && (He(n, 1, dt(e, !1)), He(n, 2)),
...
function ia(t, e, n, r) {
  return (
    ...
    t.h || (t.m(), t.C()),
    n
      ? (t.s || (t.s = na(t, !0)), (n = t.s))
      : (t.v || (t.v = na(t, !1)), (n = t.v)),
    e.useProgram(t.h),
    n.bind(),
    t.l(),
    (t = r()),
...
var ha = class extends ca {
    ...
    C() {
      ...
      (t.activeTexture(t.TEXTURE1),
        (this.B = sa(this, t, t.LINEAR)),
        t.activeTexture(t.TEXTURE2),
        (this.j = sa(this, t, t.NEAREST)));
    }
    m() {
      super.m();
      const t = this.g;
...
function ya(t) {
  ...
  return (
    n ||
      ((n = sa(ma(t), e, t.m ? e.LINEAR : e.NEAREST)), t.g.push(n), (t.j = !0)),
...
var wa = 250;
const Ta = { color: "white", lineWidth: 4, radius: 6 };
function Aa(t) {
  return { ...Ta, fillColor: (t = t || {}).color, ...t };
}
function ba(t, e) {
...
function La(t, e, n) {
  if (e.R()) n(e.N());
    ...
    t.m = t.m ?? new ca();
    const i = xa(t);
    (n((t = new Ea([r], e.m, !1, i.canvas, t.m, e.width, e.height)).N()),
      t.close());
  }
}
function Ra(t, e, n, r) {
  ...
  wa(t, e) {
    if (t) {
      ...
      var r = n.canvas,
        i = 0;
      for (const s of t)
        ((n.fillStyle = ba(e.fillColor, { index: i, from: s })),
          (n.strokeStyle = ba(e.color, { index: i, from: s })),
          (n.lineWidth = ba(e.lineWidth, { index: i, from: s })),
          (t = new Path2D()).arc(
            s.x * r.width,
            s.y * r.height,
            ba(e.radius, { index: i, from: s }),
            0,
            2 * Math.PI,
          ),
          n.fill(t),
  ...
  va(t, e, n) {
    if (t && e) {
      ...
      for (const o of e) {
        ...
        (e &&
          a &&
          ((r.strokeStyle = ba(n.color, { index: s, from: e, to: a })),
          (r.lineWidth = ba(n.lineWidth, { index: s, from: e, to: a })),
...
function Da(t) {
  ...
  let n = Ma(t, 2);
  return (
    n || ((n = sa(Ua(t), e)), t.g.push(n), (t.m = !0)),
    e.bindTexture(e.TEXTURE_2D, n),
    n
  );
}
...
((Ia.prototype.close = Ia.prototype.close),
  (Ia.prototype.drawConfidenceMask = Ia.prototype.ua),
  (Ia.prototype.drawCategoryMask = Ia.prototype.ta),
  (Ia.prototype.drawBoundingBox = Ia.prototype.sa),
  (Ia.prototype.drawConnectors = Ia.prototype.va),
  (Ia.prototype.drawLandmarks = Ia.prototype.wa),
  (Ia.lerp = function (t, e, n, r, i) {
...
function qa(t, e, n, r) {
  ...
  return ((t = new Ea([i], n, !1, t.g.i.canvas, t.P, s, e)), r ? t.clone() : t);
}
...
var Za = class extends Ja {
  constructor(t, e) {
    (super(new Wa(t, e), "image_in", "norm_rect_in", !1),
      (this.j = { detections: [] }),
...
var uc = class extends Ja {
  constructor(t, e) {
    (super(new Wa(t, e), "image_in", "norm_rect", !1),
      (this.j = {
        faceLandmarks: [],
        faceBlendshapes: [],
        facialTransformationMatrixes: [],
...
var lc = class extends Ja {
  constructor(t, e) {
    (super(new Wa(t, e), "image_in", "norm_rect", !0),
  ...
  Ka(t, e, n) {
    ...
    if (
      ((this.h = "function" == typeof e ? e : n), Ya(this, t, r ?? {}), !this.h)
    )
      return this.s;
  }
  m() {
    ...
    (Xi(n, "mediapipe.tasks.vision.face_stylizer.FaceStylizerGraph"),
      ...
      this.g.V("stylized_image", (t, e) => {
        ...
        ((i = new Ga([r], !1, !1, this.g.i.canvas, this.P, i, t)),
    ...
    return (
      t.customGesturesClassifierOptions
        ? (dn(
            ...
            0,
            2,
            (r = ko(t.customGesturesClassifierOptions, hn(this.h, Ws, 4)?.h())),
          ),
          dn(this.h, 0, 4, e))
...
var Ac = class extends Ja {
  constructor(t, e) {
    (super(new Wa(t, e), "input_frames_image", null, !1),
      (this.h = {
        faceLandmarks: [],
        faceBlendshapes: [],
        poseLandmarks: [],
    ...
    (Xi(
      ...
      this.outputPoseSegmentationMasks &&
        ...
        this.g.V("pose_segmentation_mask", (t, e) => {
          ((this.h.poseSegmentationMasks = [qa(this, t, !0, !this.C)]),
            Yo(this, e));
        }),
      ...
      this.outputFaceBlendshapes &&
        ...
        this.g.attachProtoListener("extra_blendshapes", (t, e) => {
          ...
          (this.outputFaceBlendshapes && ((t = ss(t)), n.push(So(t.g() ?? []))),
            Yo(this, e));
        }),
...
var bc = class extends Ja {
  constructor(t, e) {
    (super(new Wa(t, e), "input_image", "norm_rect", !0),
    ...
    (Xi(n, "mediapipe.tasks.vision.image_segmenter.ImageSegmenterGraph"),
      ...
      this.outputConfidenceMasks &&
        ...
        this.g.ba("confidence_masks", (t, e) => {
          ((this.confidenceMasks = t.map((t) => qa(this, t, !0, !this.j))),
            Yo(this, e));
        }),
...
var Xc = class extends Ja {
  constructor(t, e) {
    (super(new Wa(t, e), "input_frame_gpu", "norm_rect", !1),
      (this.j = { detections: [] }),
    ...
    (Xi(n, "mediapipe.tasks.vision.pose_landmarker.PoseLandmarkerGraph"),
      ...
      this.outputSegmentationMasks &&
        ...
        this.g.ba("segmentation_masks", (t, e) => {
          ((this.segmentationMasks = t.map((t) => qa(this, t, !0, !this.s))),
            Yo(this, e));
        }),
