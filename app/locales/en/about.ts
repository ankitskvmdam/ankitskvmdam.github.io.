const about = {
  title: "A curious engineer who loves to build, and sometimes break,things!",
  description:
    "It all began in 2003 (or maybe 2004) when I first discovered computers. The spark of curiosity to learn about computers led me to explore the world of programming.",

  beginning: `Between 2003 and 2017, I found myself exploring computers in every possible way. I started by learning how to
  install Windows (yes, I tackled the hard part first), then moved on to drawing mysterious things in MS Paint and giving commands
  to MS Logo’s turtle. Games came next—first playing them, then wanting to create them. That curiosity opened the door to something
  new, learning the language used to talk to computers. <1 /><1 />

  I experimented with Unity and built small projects, and around the same time, I discovered the fact that you could use Notepad to
  write HTML and CSS. That simple discovery pulled me into the world of web development. This became a milestone for me, marking the
  moment I truly began my journey into frontend development.`,

  assan: `My true professional journey began in 2017, when I co-founded <0>Asaan Contracts Private Limited</0> with my brothers and close friends.
  ...
  branding assets. It was intense, chaotic, and honestly... a lot of fun.`,

  uoc: `After Asaan and completing my undergraduate degree, I moved to the UK and joined a small lab at the <0>University of Cambridge</0>
  ...
  academic environments function, and the unique challenges they bring.`,

  startbahn: `From there, I moved to Japan, where I joined <0>Startbahn</0>, a startup focused on building blockchain infrastructure for the creative industries.
  ...
  bodygram: `Then came summer 2023—and a new chapter with <0>Bodygram</0>, where I joined as a Software Engineer. Bodygram is on a mission to help businesses
