...
export function ArticleRoot(props: React.PropsWithChildren) {
    ...
    return (
        <article className={cn(
            ...
            "[&_blockquote]:py-2 [&_blockquote]:pl-4 [&_blockquote]:border-l-[0.25rem] [&_blockquote]:border-l-foreground [&_blockquote]:text-sm [&_blockquote]:bg-muted [&_blockquote]:leading-relaxed",
